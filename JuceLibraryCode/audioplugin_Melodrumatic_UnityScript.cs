...
public class audioplugin_MelodrumaticGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_Melodrumatic"; } }
    public override string Description    { get { return "Melodrumatic"; } }
    public override string Vendor         { get { return "David Su"; } }

    //==============================================================================
	[DllImport("audioplugin_Melodrumatic")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_Melodrumatic")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_Melodrumatic")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Melodrumatic")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Melodrumatic")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_Melodrumatic")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_Melodrumatic")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
